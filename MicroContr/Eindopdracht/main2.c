...
//{
	...
	////
		////SPCR = 0b11011010;			// master, interrupt enable, 125 Mb/s									// clock idle high, sample at leading edge
	//////  
	////SPSR = 0;DDRB = 0xFF;					// PORTB is outputDDRB &= ~BIT(3);			// PORTB.3 = MISO is input
//
//}
//
///******************************************************************/
